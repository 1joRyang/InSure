...
/**  
 * @subject     : 유저정보 관련 처리를 담당하는 DAO
 * @description : 유저정보 관련 처리를 담당하는 DAO
 * @author      : hyunwoo
 * @since       : 2025/07/01
 * @modification
 * ===========================================================
...
public class UserDAO extends com.demo.proworks.cmmn.dao.ProworksDefaultAbstractDAO {
    ...
    /**
     * 페이징을 처리하여 유저정보 목록조회를 한다.
     *  
     * @param  UserVo 유저정보
     * @return List<UserVo> 유저정보
     * @throws ElException
     */
    ...
    /**
     * 유저정보 목록 조회의 전체 카운트를 조회한다.
     *  
     * @param  UserVo 유저정보
     * @return 유저정보 조회의 전체 카운트
     * @throws ElException
     */
