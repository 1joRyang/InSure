...
@ElDto(FldYn = "", logicalName = "사용자보험정보")
public class UserInsuranceVo extends com.demo.proworks.cmmn.ProworksCommVO {
    ...
    @ElDtoField(logicalName = "insu_type", physicalName = "insu_type", type = "String", typeKind = "", fldYn = "", length = 0, dotLen = 0, baseValue = "", desc = "보험종류")
    private String insu_type;

    @ElDtoField(logicalName = "insu_name", physicalName = "insu_name", type = "String", typeKind = "", fldYn = "", length = 0, dotLen = 0, baseValue = "", desc = "보험명")
    ...
    @ElVoField(physicalName = "insu_type")
    ...
    public String toString() {
        return "UserInsuranceVo [insu_id=" + insu_id + ",ID=" + ID + ",user_name=" + user_name + ",start_date=" + start_date + ",end_date=" + end_date + ",insu_amt=" + insu_amt + ",insu_type=" + insu_type + ",insu_name=" + insu_name + "]";
    }
