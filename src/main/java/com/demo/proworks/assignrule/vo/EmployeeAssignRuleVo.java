...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "자동배정용 직원정보")
public class EmployeeAssignRuleVo extends com.demo.proworks.cmmn.ProworksCommVO {
    private static final long serialVersionUID = 1L;

    public EmployeeAssignRuleVo(){
    }
    ...
    public String toString() {
        ...
        sb.append("EmployeeAssignRuleVo [");
