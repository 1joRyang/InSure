...
public class ProworksUserHeader extends com.inswave.elfw.core.UserHeader {
    ...
    @ElDtoField(logicalName = "역할", physicalName = "userRole", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "", attr = "")
    ...
    public String toString() {
        ...
        sb.append("userRole").append("=").append(userRole);
        sb.append("]");
        return sb.toString();
