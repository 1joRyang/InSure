 ...
 * 2025/07/17 hyunwoo 유니코드 디코딩 및 로직 개선
 * 2025/07/18 hyunwoo 성능 측정 기능 추가
 * 2025/07/21 hyunwoo 통합 API 서버 사용으로 변경
 *
 */
@Service("ocrService")
public class OcrServiceImpl implements OcrService {
    ...
    static {
        ...
        OCR_TO_CLAIM_TYPE.put("미분류", DEFAULT_CLAIM_TYPE);
    }
    ...
    public String analyzeDocumentType(List<String> s3ObjectKeys) throws Exception {
        ...
        if (s3ObjectKeys == null || s3ObjectKeys.isEmpty()) {
            System.out.println("S3 객체 키가 없어서 실손(기본값) 반환: " + DEFAULT_CLAIM_TYPE);
    ...
    public OcrAnalysisResult analyzeSingleDocument(String s3ObjectKey) throws Exception {
        ...
        try {
            ...
            System.out.println(" 총 처리 시간: " + totalSingleDocTime + "ms");
